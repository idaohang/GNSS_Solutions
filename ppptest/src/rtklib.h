...
#define PMODE_PPP_KINEMA 6              /* positioning mode: PPP-kinematic */
...
#define STRFMT_UB380 20                 /*stream format: 和芯星通 UB380 */
...
#define FILEPATHSEP '/'
	...
	extern int myPPP_RES(int iter, const obsd_t *obs, int n, const double *rs,
	...
	extern int getEPH(char* ntrip_str);
