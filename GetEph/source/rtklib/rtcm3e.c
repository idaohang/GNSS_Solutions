...
extern int encode_rtcm3(rtcm_t *rtcm, int type, int sync)
{
    ...
    switch (type) {
        ...
        case 1019: ret=encode_type1019(rtcm,sync);     break; //GPS
        case 1020: ret=encode_type1020(rtcm,sync);     break; //GLO
        case 1033: ret=encode_type1033(rtcm,sync);     break;
        case 1044: ret=encode_type1044(rtcm,sync);     break; //QZSS
        case 1045: ret=encode_type1045(rtcm,sync);     break; //GAL
        case 1047: ret=encode_type1047(rtcm,sync);     break; /* tentative mt */ //cmp
